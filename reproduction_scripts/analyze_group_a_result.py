...
OUTPUT_IMG = os.path.join(OUTPUT_DIR, "group_a_verification_chart.png")
...
# ====== Extract statistical data (all fields)======
stats = {
...
# Style adjustment
plt.title("Group A Packet Verification Result", fontsize=14)
