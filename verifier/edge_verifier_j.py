...
PORT_LISTEN = 443
CREDENTIAL_FILE = "public_credential.json"       # Currently active public key
IPV6_CLIENT_FILE = "client_ipv6.json"            # Legitimate client IPv6 address
LOG_FILE = "verification_log.json"               # Output log file
...
# ====== Load public key and legitimate client IPv6 ======
...
# ====== Interrupt handling and log saving ======
def save_log(sig, frame):
...
signal.signal(signal.SIGINT, save_log)
...
sniff(filter=f"ip6 and udp port {PORT_LISTEN}", prn=verify)